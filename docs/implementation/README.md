...
| 8 | One-time checkout, purchased recipe access, refunds and recovery | [Phase 8 overview](phase-8/README.md) | Detailed plan documented, commercial decisions and implementation pending |
