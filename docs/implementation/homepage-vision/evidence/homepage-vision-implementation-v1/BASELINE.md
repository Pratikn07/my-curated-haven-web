...
Changed application surface: the home page, root/home metadata, navigation anchor, bounded consent-aware homepage analytics, the image derivative, route assertions and focused tests. Existing public routes and Phase 1–12 numbering remain in place. No schema, payment, native application, waitlist, provider or customer-message changes were made.
